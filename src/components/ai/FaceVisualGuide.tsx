...
export const CIRCLE_GUIDE_OUTLINE =
  "M355 145 C517.9 145 650 277.1 650 440 C650 602.9 517.9 735 355 735 C192.1 735 60 602.9 60 440 C60 277.1 192.1 145 355 145 Z";
...
export const FACE_FEATURE_ALIGNMENT_PATH =
  "M74 138 L94 138 " +
  "M147 138 L166 138 " +
  "M120 175 L120 184 " +
  "M120 213 L120 222";
